...
export function WindowConfirm({open,close,taskId}:WindowProps){
  ...
  function handleClick(){
    UpdateTypeTask({taskId:taskId,type:'Completed'});
    close();
  }
    return(
        <div
      ...
      >
       <div className="bg-white rounded-xl shadow p-4 w-9/12 xl:w-3/12 px-6 transition-all relative flex flex-col justify-center items-center md:text-2xl">
       <p>If you mark a task as <strong  className="text-green-400">completed</strong>, you will not be able to undo the change. Are you sure you want to do it?</p>
