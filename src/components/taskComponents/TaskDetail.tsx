...
export function TaskDetail(){
  ...
  >
       <div className="bg-white rounded-xl shadow p-6 w-5/6 px-10 transition-all relative overflow-y-auto max-h-[80vh]">
    ...
    <span className="text-center mx-auto">{`${DetailLimitDate.toLocaleDateString(
            "es-CO")}`}</span>
